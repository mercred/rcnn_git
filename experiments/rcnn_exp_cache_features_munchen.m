function rcnn_exp_cache_features_munchen(chunk)

% -------------------- CONFIG --------------------
net_file     = './data/caffe_nets/finetune_voc_2007_trainval_iter_70k';
cache_name   = 'v1_finetune_munchen_trainval_iter_70k';
crop_mode    = 'warp';
crop_padding = 16;

% change to point to your dataset install
Munchen = './datasets/3k_Munchen';
% ------------------------------------------------

imdb_train = imdb_from_munchen(Munchen, 'train');
imdb_val   = imdb_from_munchen(Munchen, 'val');
imdb_test  = imdb_from_munchen(Munchen, 'test');
imdb_trainval = imdb_from_munchen(Munchen, 'trainval');
switch chunk
  case 'train'
